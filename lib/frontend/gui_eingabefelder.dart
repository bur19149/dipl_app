	...
	Widget build(BuildContext context) {
		return SizedBox(
				...
				child: Theme(
						...
						child: TextFormField(minLines: widget.multiline ? 2 : null, onChanged: widget.onChanged,
...
class _CustomFormState extends State<_CustomForm> {
	...
	TextEditingController controller;				 // Controller des Textfeldes
	// @formatter:on
				...
				child: InkWell(
						...
						child: _Feld(
								...
								validator: (val) {
									...
									_error = true;
									return widget.pruefung.errortext;
								}
						)));
	}
}
																	...
																	child: Stack(children: [
																		Align(
																				...
																				child: SvgPicture.asset(
																						SVGicons.kalender,
																						height: 22,
																						color: _error ? Farben.rot : (_focus
																								? Farben.dunkelgrau
																								: Farben.blaugrau)))
																	]))),
													decoration: BoxDecoration(
															...
															Border.all(width: 2,
																	color: _error ? Farben.rot : Farben
																			.dunkelgrau) :
															Border.all(
																	width: 1.2, color: _error ? Farben.rot :
...
class Pruefung {
	final Function(dynamic) pruefung;
	final String errortext;

  Pruefung({@required this.pruefung, this.errortext = 'Fehler'});
}
